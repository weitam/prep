...
namespace prep.utility.filtering
{
  public static class MatchCreationExtensions
  {
    ...
    public static IMatchAn<ItemToFind> create_using<ItemToFind, PropertyType>(
      this MatchCreationExtensionPoint<ItemToFind, PropertyType> extension_point, IMatchAn<PropertyType> real_criteria)
    {
    ...
    public static IMatchAn<ItemToFind> greater_than<ItemToFind,PropertyType>(this MatchCreationExtensionPoint<ItemToFind,PropertyType> extension_point,PropertyType value) where PropertyType : IComparable<PropertyType>
    {
    ...
    public static IMatchAn<ItemToFind> between<ItemToFind, PropertyType>(
      this MatchCreationExtensionPoint<ItemToFind, PropertyType> extension_point, PropertyType start, PropertyType end) where PropertyType : IComparable<PropertyType>
    {
